...
// GraphSSN graphs the 64 bit ssn weight files
func GraphSSN(directory string) {
...
// LearnSSN learns 64bit ssn r2n2 model
func LearnSSN(name string) {
...
// InferenceSSN inference 64 bit ssn r2n2 model
func InferenceSSN() {
